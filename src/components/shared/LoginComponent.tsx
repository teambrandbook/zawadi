...
export default function LoginComponent() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#d9d1c5] pt-40 px-4 py-8 sm:px-6 lg:px-8">
      <div
      ...
      <div className="mx-auto w-full max-w-[1500px]">
        <div className="overflow-hidden rounded-[34px] border-[7px] border-white bg-transparent shadow-[0_35px_90px_rgba(42,33,16,0.18)]">

          <div className="grid min-h-[500px] lg:grid-cols-2">

            {/* ✅ LEFT SIDE (rounded fixed) */}
            <div className="relative min-h-[280px] hidden sm:block overflow-hidden rounded-[34px]">
              {/* Background video will be visible */}
            </div>

            {/* RIGHT SIDE */}
            <div className="flex items-center justify-center bg-white px-6 py-7 sm:px-10 lg:px-14 lg:py-9">
