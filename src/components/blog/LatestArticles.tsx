            ...
            <div className="max-w-[85rem] mx-auto flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
                    {articles.map((article) => (
                        <Link key={article.id} href={`/blog/${article.slug}`} className="bg-[#0A4834] p-4 flex flex-col gap-4 shadow-lg border border-[#0A4834] group hover:scale-[1.02] transition-transform">
