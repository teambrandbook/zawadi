                ...
                <div className="max-w-[85rem] mx-auto flex flex-col gap-16">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                        {["Breakfast", "Lunch", "Snack", "Dinner"].map((category) => (
                            <button
                                key={category}
                                className="h-16 md:h-20 bg-[#0A4834] rounded-full w-full text-white font-sans font-extrabold text-sm md:text-xl uppercase tracking-widest hover:bg-[#1A5A44] transition-all hover:scale-105 active:scale-95 shadow-lg"
                            >
                                {category}
                            </button>
                        ))}
