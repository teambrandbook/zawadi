...
export default function Testimonials() {
    ...
    // Transition effect for content change
    useGSAP(() => {
        const tl = gsap.timeline();
        tl.fromTo(".testimonial-card-left", 
            { opacity: 0, x: -20 },
    ...
    return (
        <section ref={sectionRef} className="relative w-full py-24 md:py-36 px-6 md:px-12 lg:px-24 flex items-center justify-center overflow-hidden bg-white">
            ...
            <div className="relative z-10 w-full max-w-[90rem]">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 w-full">
                        ...
                        {/* Current Slide */}
                        <div className="testimonial-card-left bg-white flex w-full h-auto min-h-[320px] shadow-2xl rounded-sm overflow-hidden">
                            {/* Left Integrated Nav */}
                            <button 
                                onClick={prevSlide}
