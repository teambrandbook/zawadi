            ...
            <div className="max-w-[85rem] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-6 mt-4">
                        {/* Wide Light Button */}
                        <Link href="/recipe/buckwheat-salad" className="h-14 md:h-16 w-48 md:w-56 bg-[#0A4834] rounded-full hover:bg-[#1A5A44] transition-colors shadow-sm flex items-center justify-center text-white font-sans font-bold text-sm uppercase tracking-widest">
                            View Detail
                        </Link>

                        {/* Dark Circle Button */}
                        <Link href="/recipe/buckwheat-salad" className="h-14 w-14 md:h-16 md:w-16 bg-[#0A4834] rounded-full flex items-center justify-center hover:bg-[#1A5A44] transition-colors shadow-md text-white">
                ...
                <div className="w-full aspect-square relative rounded-sm shadow-sm order-first lg:order-last overflow-hidden">
                    <Image src="/recipe/recipe-2.webp" alt="Buckwheat Veg Salad" fill className="object-cover" />
                </div>
