...
from .views import (
    ...
    ConsultationBookingOTPConfirmView,
    ConsultationBookingOTPRequestView,
    CommunityBookingCancelView,
    CommunityBookingRescheduleView,
...
urlpatterns = [
    ...
    path("community/booking-otp/request/", ConsultationBookingOTPRequestView.as_view()),
    path("community/booking-otp/confirm/", ConsultationBookingOTPConfirmView.as_view()),
    path("bookings/<int:pk>/cancel/", CommunityBookingCancelView.as_view()),
    path("bookings/<int:pk>/reschedule/", CommunityBookingRescheduleView.as_view()),
