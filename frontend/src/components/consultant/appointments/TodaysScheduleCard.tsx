...
type Props = {
  onViewDetails: (appointment: ScheduleItem) => void;
};

export default function TodaysScheduleCard({ onViewDetails }: Props) {
  return (
    <section className="overflow-hidden rounded-[16px] border border-[#E4E7EC] bg-white shadow-[0_8px_24px_rgba(16,24,40,0.04)]">
      <div className="border-b border-[#EAECF0] px-5 py-4">
        <h2 className="text-lg font-semibold text-[#0A4833]">Today&apos;s Schedule</h2>
        <p className="mt-1 text-xs text-[#98A2B3]">Friday, March 15, 2024</p>
      </div>
