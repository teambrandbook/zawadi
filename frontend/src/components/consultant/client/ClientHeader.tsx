        ...
        <div className="grid grid-cols-2 gap-3 sm:flex sm:items-center sm:justify-end">
          <div className="relative col-span-1">
            <select
              ...
              className="h-11 w-full sm:min-w-[140px] appearance-none rounded-[10px] border border-[#E4E7EC] bg-white px-4 pr-10 text-sm text-[#344054] outline-none transition focus:border-[#0A4833]"
            >
          ...
          <button
            type="button"
            className="col-span-2 sm:col-auto inline-flex h-11 items-center justify-center gap-2 rounded-[10px] bg-[#0A4833] px-4 text-sm font-medium text-white transition hover:bg-[#083727]"
          >
