        ...
        <section className="w-full bg-white  px-6 md:px-12 lg:px-24">
            <div className="max-w-[85rem] mx-auto flex flex-col items-center">
                ...
                <div className="text-center max-w-4xl mb-16 flex flex-col gap-6">
                    <h2 className="font-playfair text-3xl md:text-4xl lg:text-6xl font-semibold text-[#0A4834] mb-8 tracking-tight leading-none">
                        Quick Answers to Common Questions
                    </h2>
                    <p className="font-inter text-[#004E3B] text-sm md:text-lg leading-relaxed max-w-3xl mx-auto">
