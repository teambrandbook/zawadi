        ...
        <section className="w-full bg-white py-24 px-6 md:px-12 lg:px-24">
            <div className="max-w-[85rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#EAE3D2] rounded-xl p-8 md:p-10 flex items-start gap-6 border border-[#0A4834]/10 transition-all duration-300 hover:bg-[#0A4834] group hover:shadow-xl">
                    ...
                    <div>
                        <h3 className="font-akatab text-base font-semibold text-[#0A4834] group-hover:text-white mb-4 transition-colors">Visit Our Bakery</h3>
                        <p className="font-akatab text-[#555] group-hover:text-white/90 text-sm leading-relaxed transition-colors">
                ...
                <div className="bg-[#EAE3D2] rounded-xl p-8 md:p-10 flex items-start gap-6 border border-[#0A4834]/10 transition-all duration-300 hover:bg-[#0A4834] group hover:shadow-xl">
                    ...
                    <div>
                        <h3 className="font-akatab text-base font-semibold text-[#0A4834] group-hover:text-white mb-4 transition-colors">Call Us</h3>
                        <p className="font-akatab text-[#555] group-hover:text-white/90 text-sm leading-relaxed transition-colors">
                            +1 (555) 123-COOKIE<br />
                ...
                <div className="bg-[#EAE3D2] rounded-xl p-8 md:p-10 flex items-start gap-6 border border-[#0A4834]/10 transition-all duration-300 hover:bg-[#0A4834] group hover:shadow-xl">
                    ...
                    <div>
                        <h3 className="font-akatab text-base font-semibold text-[#0A4834] group-hover:text-white mb-4 transition-colors">Email Us</h3>
                        <div className="font-akatab text-[#555] group-hover:text-white/90 text-sm leading-relaxed flex flex-col transition-colors">
