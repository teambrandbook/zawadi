            ...
            <div className="max-w-[85rem] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                ...
                <div className="hero-content flex flex-col">
                    ...
                    <div className="mb-8 content-item">
                        <h1 className="font-playfair text-3xl md:text-[3rem] font-semibold text-black tracking-tight leading-none mb-8">
                            Buckwheat
                        </h1>
                        <p className="font-inter text-xl font-extrabold text-black">
                            $ 120.00 USD
                        </p>
                    </div>

                    {/* Description */}
                    <p className="content-item font-inter text-[#000000] text-[15px] leading-relaxed mb-10 max-w-2xl">
                    ...
                    <div className="content-item mb-12">
                        <ul className="list-disc list-outside ml-5 space-y-1 font-inter text-black text-[15px] leading-relaxed font-medium">
                    ...
                    <div className="flex gap-4 mb-20 items-center">
                        <div className="content-wipe">
                            <button
                                ...
                                className="w-13 h-13 bg-[#0A4834] rounded-full flex items-center justify-center text-white hover:brightness-110 transition-all shadow-md relative overflow-hidden"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 pt-12 items-start border-t border-gray-100">
                        <div className="content-item flex flex-col items-start gap-4">
                            <h4 className="font-playfair text-base font-semibold text-black tracking-tight">Zewadi Story</h4>
                            <p className="font-inter text-[#000000] text-[13px] leading-relaxed max-w-sm">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                            <div className="content-wipe h-11 w-full max-w-[280px] mt-4">
                                <Link href="/recipe" className="w-full h-full bg-[#0A4834] rounded-none flex items-center justify-center text-white font-inter font-bold text-xs uppercase tracking-[0.2em] hover:brightness-110 transition-all shadow-md">
                                    Recipes
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="content-item flex flex-col items-start gap-4">
                            <h4 className="font-playfair text-base font-semibold text-black tracking-tight">Zewadi Story</h4>
                            <p className="font-inter text-[#000000] text-[13px] leading-relaxed">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                        </div>
                    </div>
