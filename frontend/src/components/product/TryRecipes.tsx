        ...
        <section ref={containerRef} className="w-full bg-white py-24 px-6 md:px-12 lg:px-24">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="try-recipes-header">
                    <h2 className="font-playfair text-3xl md:text-4xl lg:text-5xl font-semibold text-black text-center mb-20 tracking-tighter">
                        Try Recipes
                    </h2>
                </div>
                ...
                <div className="recipes-grid grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                    {recipes.map((recipe) => (
                        ...
                        >
                            ...
                            <p className="font-playfair text-[#D8C29A] text-lg lg:text-xl font-semibold leading-tight px-2 pb-2">
