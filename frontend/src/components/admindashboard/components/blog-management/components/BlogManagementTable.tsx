...
type BlogStatus = "Approved" | "Pending Review";
...
const rows: BlogRow[] = [
  {
    id: "b1",
    title: "My Journey Better Health with Buckwheat",
    read: "9 min read",
    category: "Wellness Journey",
    contributor: "Sarah Mitchell",
    status: "Approved",
  ...
  {
    id: "b2",
    title: "5 Delicious Buckwheat Breakfast Recipes",
    read: "6 min read",
  ...
  {
    id: "b3",
    title: "Understand the Nutrition Power of Buckwheat",
    read: "7 min read",
    category: "Healthy Recipes",
    contributor: "James Chen",
    status: "Pending Review",
...
function RowActions({ status }: { status: BlogStatus }) {
  if (status === "Approved") {
    return (
  ...
  return (
    <div className="flex items-center gap-2">
      <button type="button" className="inline-flex items-center gap-1 rounded-md bg-[#E7F7EC] px-2.5 py-1 text-[11px] font-medium text-[#15803D]">
    ...
    <section className="overflow-hidden rounded-xl border border-[#E4E7EC] bg-white">
      <div className="flex items-center justify-between border-b border-[#E4E7EC] px-4 py-2.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[12px] text-[#98A2B3]">1247 total</span>
        </div>
