          ...
          <div className="mx-auto max-w-7xl px-6 md:px-10">
            <div className="grid grid-cols-1 items-center gap-4 lg:grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <h1 className="font-playfair text-xl md:text-[3rem] font-semibold text-black tracking-tight leading-[1.3] mb-2" dangerouslySetInnerHTML={{ __html: recipe.title }}>
                </h1>

                <p className="font-sans text-black text-base leading-relaxed mb-2">
                  {recipe.description}
                </p>

                {/* Benefits */}
                <div className="mb-1">
                  <h3 className="font-display text-base font-extrabold text-black mb-2">
                    Benefits
                  </h3>
                  <ul className="list-disc list-outside ml-5 space-y-1 font-sans text-black text-sm md:text-base leading-[1.3]">
                ...
                <div className="recipe-btn-wrap mt-1 flex items-center gap-6">
                  ...
                  >
                    <span className="whitespace-nowrap px-11 font-inter text-sm font-semibold uppercase tracking-widest flex items-center">
                      View More
                    </span>
                  </Link>
