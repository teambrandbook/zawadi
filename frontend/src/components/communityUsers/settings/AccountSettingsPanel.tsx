    ...
    <div className="space-y-6">
      <section className="rounded-lg border border-[#DFDFDF] bg-white p-6">
        ...
        <div className="mt-5 grid gap-5 md:grid-cols-2">
          {accountDetails.map((detail) => (
            <div key={detail.label} className="rounded-md bg-[#E9DFCC] p-5">
      ...
      <section className="rounded-lg border border-[#DFDFDF] bg-white p-6">
        ...
        <div className="mt-5 space-y-4">
          {linkedAccounts.map((account) => (
            <article key={account.id} className="flex items-center justify-between gap-4 rounded-md border border-[#DFDFDF] bg-white p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-[#6B7280]">{account.detail}</p>
                </div>
              </div>
      ...
      <div className="flex flex-wrap gap-4">
        <button
          type="button"
          onClick={onSave}
          className="inline-flex h-11 items-center gap-2 rounded-md bg-[#06402B] px-7 text-sm font-semibold text-white hover:bg-[#053020]"
        >
        ...
        <button
          type="button"
          onClick={onCancel}
          className="h-11 rounded-md border border-[#DFDFDF] bg-white px-7 text-sm font-semibold text-[#4B5563] hover:bg-[#F9FAFB]"
        >
          Cancel
        </button>
      </div>
