...
export default function Health() {
    ...
    return (
        <section
            ref={containerRef}
            className="w-full bg-[#0A4834] py-24 px-6 md:px-12 lg:px-24 overflow-hidden relative mt-20 lg:mt-32"
        >
            <div className="max-w-[90rem] mx-auto grid grid-cols-1 lg:grid-cols-5 gap-0 md:gap-12 items-center">

                {/* Left Column */}
                <div
                    className="health-left lg:col-span-3 flex flex-col gap-8 z-10 relative"
                >
                ...
                <div className="lg:col-span-2 relative h-[200px] md:h-[400px] w-full lg:w-[150%] lg:-mr-[50%] ml-[10%] z-10 flex justify-end mt-12 lg:mt-0">
                    <div
                        className="health-right relative w-full h-full bg-[#222] rounded-l-full overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border-y border-l border-white/10"
                    >
                        <Image
